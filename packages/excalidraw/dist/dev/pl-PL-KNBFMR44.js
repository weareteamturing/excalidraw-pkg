...
var labels = {
  ...
  cut: "Wytnij",
  copy: "Kopiuj",
  copyAsPng: "Kopiuj do schowka jako plik PNG",
  copyAsSvg: "Kopiuj do schowka jako plik SVG",
  copyText: "Kopiuj do schowka jako tekst",
  copySource: "Kopiuj \u017Ar\xF3d\u0142o do schowka",
  convertToCode: "Skonwertuj na kod",
  bringForward: "Przesu\u0144 warstw\u0119 wy\u017Cej",
  sendToBack: "Przenie\u015B na sp\xF3d",
  bringToFront: "Przenie\u015B na wierzch",
  sendBackward: "Przenie\u015B warstw\u0119 ni\u017Cej",
  delete: "Usu\u0144",
  copyStyles: "Kopiuj style",
  pasteStyles: "Wklej style",
  stroke: "Kreska",
  changeStroke: "Zmie\u0144 kolor kreski",
  background: "T\u0142o",
  changeBackground: "Zmie\u0144 kolor t\u0142a",
  fill: "Wype\u0142nienie",
  strokeWidth: "Szeroko\u015B\u0107 kreski",
  strokeStyle: "Styl kreski",
  strokeStyle_solid: "Pe\u0142ny",
  strokeStyle_dashed: "Linia przerywana",
  ...
  arrowhead_circle: "Ko\u0142o",
  arrowhead_circle_outline: "Ko\u0142o (puste)",
  arrowhead_triangle: "Tr\xF3jk\u0105t",
  arrowhead_triangle_outline: "Tr\xF3jk\u0105t (pusty)",
  arrowhead_diamond: "Romb",
  arrowhead_diamond_outline: "Romb (pusty)",
  ...
  arrowtype_elbowed: "\u0141amana strza\u0142ka",
  ...
  toggleGrid: "Prze\u0142\u0105cz widoczno\u015B\u0107 siatki",
  ...
  loadScene: "Wczytaj scen\u0119 z pliku",
  align: "Wyr\xF3wnaj",
  ...
  showFonts: "Poka\u017C selektor czcionek",
  ...
  link: {
    edit: "Edytuj \u0142\u0105cze",
    editEmbed: "Edytuj osadzalne \u0142\u0105cze",
    create: "Dodaj link",
    label: "\u0141\u0105cze",
    labelEmbed: "Podlinkuj i osad\u017A",
    empty: "Brakuj\u0105cy link",
    hint: "Wpisz lub wklej sw\xF3j link tutaj",
    goToElement: "Przejd\u017A do elementu docelowego"
  },
  lineEditor: {
    edit: "Edytuj lini\u0119",
    editArrow: "Edytuj strza\u0142k\u0119"
  },
  polygon: {
    breakPolygon: "Przerwij wielok\u0105t",
    convertToPolygon: "Przekszta\u0142\u0107 w wielok\u0105t"
  },
  elementLock: {
    lock: "Zablokuj",
    unlock: "Odblokuj",
  ...
  zoomToFitViewport: "Dopasuj widok do ekranu",
  zoomToFitSelection: "Dopasuj widok do zaznaczenia",
  zoomToFit: "Dopasuj widok do ca\u0142ej zawarto\u015Bci",
  installPWA: "Zainstaluj Excalidraw lokalnie (PWA)",
  autoResize: "W\u0142\u0105cz automatyczne zmiany rozmiaru tekstu",
  imageCropping: "Przycinanie obrazu",
  unCroppedDimension: "Nieprzyci\u0119ty wymiar",
  copyElementLink: "Kopiuj link do obiektu",
  linkToElement: "Link do obiektu",
  wrapSelectionInFrame: "Owi\u0144 wyb\xF3r w ramk\u0119",
  tab: "Tab",
  shapeSwitch: "Wyb\xF3r kszta\u0142tu"
};
var elementLink = {
  title: "Link do obiektu",
  desc: "Kliknij kszta\u0142t na obszarze roboczym lub wklej link.",
  notFound: "Powi\u0105zany obiekt nie zosta\u0142 znaleziony na p\u0142\xF3tnie."
};
var library = {
  ...
  search: {
    ...
    noResults: "Nie znaleziono pasuj\u0105cych element\xF3w...",
    clearSearch: "Usu\u0144 histori\u0119 wyszukiwania"
  }
};
var search = {
  title: "Znajd\u017A na p\u0142\xF3tnie",
  noMatch: "Nie znaleziono pasuj\u0105cych element\xF3w...",
  singleResult: "wynik",
  multipleResults: "wyniki",
  placeholder: "Znajd\u017A tekst na p\u0142\xF3tnie...",
  frames: "Ramki",
  texts: "Teksty"
};
var buttons = {
...
var alerts = {
  ...
  localStorageQuotaExceeded: "Przekroczono limit pami\u0119ci przegl\u0105darki. Zmiany nie zostan\u0105 zapisane."
};
var errors = {
...
var element = {
  ...
  arrow: "Strza\u0142ka",
  line: "Linia",
  freedraw: "Rysowanie odr\u0119czne",
  text: "Tekst",
  image: "Obraz",
  group: "Grupa",
  frame: "Ramka",
  magicframe: "Kod ze szkicu",
  embeddable: "Osadzenie",
  selection: "Zaznaczenie",
  iframe: "IFrame"
};
var headings = {
...
var hints = {
  ...
  canvasPanning: "Aby przesun\u0105\u0107 p\u0142\xF3tno, przytrzymaj {{shortcut_1}} lub {{shortcut_2}} podczas przeci\u0105gania, albo u\u017Cyj narz\u0119dzia r\u0119ki",
  linearElement: "Naci\u015Bnij, aby zrobi\u0107 punkt, przeci\u0105gnij, aby narysowa\u0107 lini\u0119",
  arrowTool: "Kliknij, aby rozpocz\u0105\u0107 rysowanie wielu punkt\xF3w; przeci\u0105gnij, aby narysowa\u0107 pojedyncz\u0105 lini\u0119. Naci\u015Bnij ponownie {{shortcut}}, aby zmieni\u0107 typ strza\u0142ki.",
  arrowBindModifiers: "",
  ...
  text_selected: "Kliknij dwukrotnie lub naci\u015Bnij {{shortcut}}, aby edytowa\u0107 tekst",
  text_editing: "Naci\u015Bnij {{shortcut_1}} lub {{shortcut_2}}, aby zako\u0144czy\u0107 edycj\u0119",
  linearElementMulti: "Kliknij ostatni punkt lub naci\u015Bnij {{shortcut_1}} lub {{shortcut_2}}, aby zako\u0144czy\u0107",
  lockAngle: "Mo\u017Cesz ograniczy\u0107 k\u0105t, przytrzymuj\u0105c {{shortcut}}",
  resize: "Mo\u017Cesz zachowa\u0107 proporcje, przytrzymuj\u0105c {{shortcut_1}} podczas zmiany rozmiaru;\nprzytrzymaj {{shortcut_2}}, aby zmieni\u0107 rozmiar wzgl\u0119dem \u015Brodka",
  resizeImage: "Mo\u017Cesz dowolnie zmienia\u0107 rozmiar, przytrzymuj\u0105c {{shortcut_1}};\nprzytrzymaj {{shortcut_2}}, aby zmieni\u0107 rozmiar wzgl\u0119dem \u015Brodka.",
  rotate: "Mo\u017Cesz ograniczy\u0107 k\u0105ty, przytrzymuj\u0105c {{shortcut}} podczas obracania",
  lineEditor_info: "Przytrzymaj {{shortcut_1}} i kliknij dwukrotnie lub naci\u015Bnij {{shortcut_2}}, aby edytowa\u0107 punkty",
  lineEditor_line_info: "Kliknij dwukrotnie lub naci\u015Bnij {{shortcut}}, aby edytowa\u0107 punkty",
  lineEditor_pointSelected: "Naci\u015Bnij {{shortcut_1}}, aby usun\u0105\u0107 punkty,\n{{shortcut_2}}, aby je powieli\u0107, lub przeci\u0105gnij, aby je przenie\u015B\u0107",
  lineEditor_nothingSelected: "Wybierz punkt do edycji (przytrzymaj {{shortcut_1}}, aby wybra\u0107 wiele punkt\xF3w)\nlub przytrzymaj {{shortcut_2}} i kliknij mysz\u0105, aby doda\u0107 nowe punkty",
  ...
  deepBoxSelect: "Przytrzymaj {{shortcut}}, aby wybra\u0107 w obr\u0119bie grupy i zapobiec przeci\u0105gni\u0119ciu",
  eraserRevert: "Przytrzymaj {{shortcut}}, aby przywr\xF3ci\u0107 elementy oznaczone do usuni\u0119cia",
  ...
  enterCropEditor: "Kliknij dwukrotnie obraz lub naci\u015Bnij {{shortcut}}, aby przyci\u0105\u0107 obraz",
  leaveCropEditor: "Kliknij obszar poza obrazem albo naci\u015Bnij {{shortcut_1}} lub {{shortcut_2}}, aby zako\u0144czy\u0107 przycinanie"
};
var canvasError = {
...
var roomDialog = {
  desc_intro: "Zapro\u015B ludzi do wsp\xF3lnego rysunku.",
  desc_privacy: "Nie martw si\u0119, sesja jest szyfrowana end-to-end i w pe\u0142ni prywatna. Nawet nasz serwer nie widzi co rysujesz.",
...
var helpDialog = {
  ...
  createFlowchart: "Tw\xF3rz diagram u\u017Cywaj\u0105c generycznych element\xF3w",
  navigateFlowchart: "Nawiguj diagram",
  ...
  cropStart: "Przytnij obraz",
  cropFinish: "Zako\u0144cz przycinanie obrazu"
};
...
var stats = {
  ...
  storage: "Pami\u0119\u0107",
  fullTitle: "W\u0142a\u015Bciwo\u015Bci p\u0142\xF3tna i kszta\u0142tu",
  title: "W\u0142a\u015Bciwo\u015Bci",
  generalStats: "Og\xF3lne",
  elementProperties: "W\u0142a\u015Bciwo\u015Bci kszta\u0142tu",
  total: "\u0141\u0105cznie",
  version: "Wersja",
...
var toast = {
  ...
  copyToClipboardAsSvg: "Skopiowano {{exportSelection}} do schowka jako SVG\n({{exportColorScheme}})",
  ...
  elementLinkCopied: "\u0141\u0105cze skopiowane do schowka"
};
var colors = {
...
var fontList = {
  ...
  sceneFonts: "W tej scenie",
  availableFonts: "Dost\u0119pne czcionki",
  empty: "Nie znaleziono czcionek"
};
var userList = {
  empty: "Nie znaleziono u\u017Cytkownik\xF3w",
  hint: {
    text: "Kliknij na u\u017Cytkownika, aby obserwowa\u0107",
    followStatus: "Obserwujesz tego u\u017Cytkownika",
    inCall: "U\u017Cytkownik jest w trakcie po\u0142\u0105czenia g\u0142osowego",
    micMuted: "Mikrofon u\u017Cytkownik jest wyciszony",
    isSpeaking: "U\u017Cytkownik przemawia"
  }
};
var commandPalette = {
  ...
  search: {
    placeholder: "Szukaj w menu, poleceniach i odkrywaj ukryte funkcje",
    noMatch: "Brak pasuj\u0105cych komend..."
  },
  itemNotAvailable: "Polecenie jest niedost\u0119pne...",
...
//# sourceMappingURL=pl-PL-KNBFMR44.js.map
