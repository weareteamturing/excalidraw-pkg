...
var labels = {
  ...
  copySource: "Bron kopi\xEBren naar klembord",
  ...
  loadScene: "Laad sc\xE8ne van uit bestand",
  align: "Uitlijnen",
...
var errors = {
  ...
  copyToSystemClipboardFailed: "Kon niet naar klembord kopi\xEBren."
};
var toolBar = {
  selection: "Selectie",
...
var roomDialog = {
  ...
  desc_privacy: "Geen zorgen, de sessie is end-to-end versleuteld en volledig priv\xE9. Niet eens onze server kan zien wat je tekent.",
...
var publishDialog = {
  ...
  noteItems: "Elk bibliotheekitem moet een eigen naam hebben zodat het gefilterd kan worden. De volgende bibliotheekitems worden ge\xEFncludeerd:",
  atleastOneLibItem: "Selecteer op zijn minst \xE9\xE9n bibliotheekitem om te starten",
...
var imageExportDialog = {
  ...
  label: {
    ...
    darkMode: "Dark mode",
    embedScene: "Sc\xE8ne embedden",
    scale: "Schaal",
    padding: "Padding"
  },
  tooltip: {
    embedScene: "Sc\xE8negegevens worden opgeslagen in het ge\xEBxporteerde PNG/SVG-bestand, zodat de sc\xE8ne hieruit kan worden hersteld.\nDit zal de ge\xEBxporteerde bestandsgrootte verhogen."
  },
  title: {
    exportToPng: "Exporteer naar PNG",
    exportToSvg: "Exporteer naar SVG",
    copyPngToClipboard: "Kopieer PNG naar klembord"
  },
  button: {
    exportToPng: "PNG",
    exportToSvg: "SVG",
...
var overwriteConfirm = {
  action: {
    exportToImage: {
      ...
      description: "Exporteer de sc\xE8negegevens als een afbeelding die je later weer kunt importeren."
    },
    saveToDisk: {
      title: "Opslaan op schijf",
      button: "Opslaan op schijf",
      description: "Exporteer de sc\xE8negegevens als bestand die je later weer kunt importeren."
    },
    excalidrawPlus: {
      title: "Excalidraw+",
      button: "Exporteer naar Excalidraw+",
      description: "Sla de sc\xE8ne op in je Excalidraw+ werkruimte."
    }
  },
  modal: {
    loadFromFile: {
...
var chat = {
  ...
  viewAsMermaid: "Weergeven als Mermaid",
  placeholder: {
  ...
  errors: {
    promptTooShort: "Vraag is te kort (min {{min}} karakters)",
    promptTooLong: "Vraag is te kort (max {{max}} karakters)",
    generationFailed: "Generatie mislukt",
    invalidDiagram: "Een ongeldige diagram gegenereerd :(. Je kunt handmatig bewerken, opnieuw proberen met automatisch repareren of een andere vraag proberen.",
    fixInMermaid: "Mermaid handmatig bewerken \u2192",
  ...
  rateLimit: {
    ...
    generalRateLimit: "Ho ho, rustig aan, je gaat te snel voor ons! Wacht even voor je het opnieuw probeert.",
    messageLimitInputPlaceholder: "Je hebt je berichtenlimiet bereikt"
  },
  upsellBtnLabel: "Upgrade naar Plus"
};
var quickSearch = {
...
//# sourceMappingURL=nl-NL-BS5ERZTW.js.map
