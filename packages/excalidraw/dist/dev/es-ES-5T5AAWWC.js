...
var labels = {
  ...
  polygon: {
    breakPolygon: "Abrir pol\xEDgono",
    convertToPolygon: ""
  },
  elementLock: {
    lock: "Bloquear",
  ...
  zoomToFitSelection: "Zoom para ajustar la selecci\xF3n",
  zoomToFit: "Zoom para mostrar todos los elementos",
  installPWA: "Instalar Excalidraw localmente (PWA)",
  autoResize: "Activar redimensionado autom\xE1tico de texto",
  imageCropping: "Recortar imagen",
  unCroppedDimension: "Dimensi\xF3n no recortada",
  copyElementLink: "Copiar enlace al objeto",
  linkToElement: "Enlace al objeto",
  wrapSelectionInFrame: "Ajustar la selecci\xF3n en el marco",
  tab: "",
  shapeSwitch: ""
};
var elementLink = {
  ...
  notFound: "El objeto vinculado no se encontr\xF3 en el lienzo."
};
var library = {
...
var buttons = {
  ...
  clear: "Borrar",
  remove: "Eliminar",
  embed: "Alternar incrustaci\xF3n",
  publishLibrary: "",
  submit: "Enviar",
  confirm: "Confirmar",
...
var errors = {
  ...
  imageToolNotSupported: "Las im\xE1genes est\xE1n desactivadas.",
  brave_measure_text_error: {
    ...
    line4: "Si deshabilitar esta opci\xF3n no arregla la visualizaci\xF3n de elementos conformados por texto, por favor abre un <issueLink>problema</issueLink> en nuestro GitHub o escr\xEDbanos en <discordLink>Discord</discordLink>"
  },
  libraryElementTypeError: {
    embeddable: "Los elementos incrustables no pueden ser a\xF1adidos a la biblioteca.",
    iframe: "Los elementos IFrame no se pueden agregar a la biblioteca.",
    image: "\xA1Soporte para a\xF1adir im\xE1genes a la biblioteca muy pronto!"
  },
...
var roomDialog = {
  ...
  desc_privacy: "No te preocupes, la sesi\xF3n est\xE1 encriptada de extremo a extremo y es totalmente privada. Ni siquiera nuestro servidor puede ver lo que dibujas.",
...
var helpDialog = {
  ...
  createFlowchart: "Crear un diagrama de flujo a partir de un elemento gen\xE9rico",
...
var imageExportDialog = {
  ...
  tooltip: {
    embedScene: "Los datos de la escena se guardar\xE1n en el archivo PNG/SVG exportado, as\xED la escena puede ser restaurada desde la misma. Esto acci\xF3n aumentar\xE1 el tama\xF1o del archivo exportado."
  },
  title: {
...
var toast = {
  ...
  unableToEmbed: "Incorporar esta url no est\xE1 permitido actualmente. Se\xF1ale esta incidencia en nuestro GitHub para solicitar que esta url est\xE9 entre las permitidas",
  unrecognizedLinkFormat: "El enlace que incrust\xF3 no coincide con el formato esperado. Por favor intente pegar la cadena 'embed' proporcionada por el sitio de origen",
...
var overwriteConfirm = {
  action: {
    exportToImage: {
      ...
      description: "Exporta los datos de la escena como una imagen desde el cual podr\xE1s importarlo m\xE1s tarde."
    },
    saveToDisk: {
  ...
  modal: {
    loadFromFile: {
      ...
      description: "Cargando desde un archivo <bold>reemplazar\xE1 tu contenido actual</bold> <br></br>Puedes primero hacer una copia de seguridad usando una de las siguientes opciones."
    },
    shareableLink: {
...
var mermaid = {
  ...
  button: "Insertar",
  description: "Actualmente s\xF3lo estos tipos de <flowchartLink>diagrama de flujo</flowchartLink>,<sequenceLink> Secuencia, </sequenceLink> y <classLink>Clase </classLink> son soportados. Los otros tipos de diagramas se renderizar\xE1n como imagen en Excalidraw.",
...
var quickSearch = {
  placeholder: "B\xFAsqueda r\xE1pida"
};
var fontList = {
  badge: {
    old: "viejo"
...
var userList = {
  ...
  hint: {
    ...
    followStatus: "Ya est\xE1s siguiendo a este usuario",
    inCall: "El usuario est\xE1 en una llamada de voz",
    micMuted: "El micr\xF3fono del usuario est\xE1 silenciado",
    isSpeaking: "El usuario est\xE1 hablando"
  }
};
var commandPalette = {
  ...
  search: {
    placeholder: "Busca men\xFAs, comandos y descubre gemas ocultas",
...
//# sourceMappingURL=es-ES-5T5AAWWC.js.map
