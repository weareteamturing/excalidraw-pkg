...
var labels = {
  ...
  stroke: "Linje",
  changeStroke: "\xC4ndra streckf\xE4rg",
  background: "Bakgrund",
  changeBackground: "\xC4ndra bakgrundsf\xE4rg",
  fill: "Fyllnad",
  ...
  arrowhead_diamond_outline: "Romb (kontur)",
  arrowhead_crowfoot_many: "Kr\xE5kfot (m\xE5nga)",
  arrowhead_crowfoot_one: "Kr\xE5kfot (en)",
  arrowhead_crowfoot_one_or_many: "Kr\xE5kfot (en eller m\xE5nga)",
  more_options: "Fler alternativ",
  arrowtypes: "Piltyp",
  arrowtype_sharp: "Rak",
  arrowtype_round: "B\xF6jd",
  arrowtype_elbowed: "Vinklad",
  ...
  toggleGrid: "Visa/d\xF6lj rutn\xE4t",
  ...
  loadScene: "Ladda scen fr\xE5n fil",
  align: "Justera",
  ...
  showFonts: "Visa typsnittsv\xE4ljare",
  toggleTheme: "V\xE4xla ljus/m\xF6rkt tema",
  theme: "Tema",
  ...
  link: {
    ...
    editEmbed: "Redigera inb\xE4ddningsbar l\xE4nk",
    create: "L\xE4gg till l\xE4nk",
    label: "L\xE4nk",
    labelEmbed: "L\xE4nka & b\xE4dda in",
    empty: "Ingen l\xE4nk \xE4r angiven",
    hint: "Skriv eller klistra in din l\xE4nk h\xE4r",
    goToElement: "G\xE5 till m\xE5lelementet"
  },
  lineEditor: {
    edit: "Redigera linje",
    editArrow: "Redigera pil"
  },
  polygon: {
    breakPolygon: "Dela polygon",
    convertToPolygon: "Konvertera till polygon"
  },
  elementLock: {
    lock: "L\xE5s",
    unlock: "L\xE5s upp",
  ...
  prompt: "Inmatning",
  followUs: "F\xF6lj oss",
  discordChat: "Discord chat",
  zoomToFitViewport: "Zooma f\xF6r att passa in i vyn",
  zoomToFitSelection: "Zooma f\xF6r att passa urval",
  zoomToFit: "Zooma f\xF6r att rymma alla element",
  installPWA: "Installera Excalidraw lokalt (PWA)",
  autoResize: "Aktivera automatisk skalning av text",
  imageCropping: "Bildbesk\xE4rning",
  unCroppedDimension: "Obeskuren dimension",
  copyElementLink: "Kopiera l\xE4nk till objektet",
  linkToElement: "L\xE4nk till objektet",
  wrapSelectionInFrame: "Omslut urvaled i ram",
  tab: "Flik",
  shapeSwitch: ""
};
var elementLink = {
  title: "L\xE4nk till objektet",
  desc: "Klicka p\xE5 en figur p\xE5 canvas eller klistra in en l\xE4nk.",
  notFound: "L\xE4nkat objekt hittades inte p\xE5 canvas."
};
var library = {
...
var search = {
  title: "Hitta p\xE5 canvas",
  noMatch: "Inga tr\xE4ffar hittades...",
  singleResult: "resultat",
  multipleResults: "resultat",
  placeholder: "Hitta text p\xE5 canvas...",
  frames: "",
  texts: ""
};
var buttons = {
...
var errors = {
  ...
  saveLibraryError: "Det gick inte att spara biblioteket till lagring. Spara biblioteket till en fil lokalt f\xF6r att se till att du inte f\xF6rlorar \xE4ndringar.",
  ...
  asyncPasteFailedOnRead: "Det gick inte att klistra in (kunde inte l\xE4sa fr\xE5n urklipp).",
...
var roomDialog = {
  desc_intro: "Bjud in personer att samarbeta p\xE5 din ritning.",
  desc_privacy: "Oroa dig inte, sessionen \xE4r krypterad och helt privat. Inte ens v\xE5r server kan se vad du ritar.",
...
var helpDialog = {
  ...
  createFlowchart: "Skapa ett fl\xF6desschema fr\xE5n ett generiskt element",
  navigateFlowchart: "Navigera ett fl\xF6desschema",
  ...
  cropStart: "Besk\xE4r bild",
  cropFinish: "Slutf\xF6r bildbesk\xE4rningen"
};
...
var stats = {
  ...
  selected: "Valda",
  storage: "Lagring",
  fullTitle: "Egenskaper f\xF6r Canvas & Form",
  title: "Egenskaper",
  generalStats: "Allm\xE4n",
  elementProperties: "Formegenskaper",
  total: "Totalt",
  version: "Version",
...
var toast = {
  ...
  copyToClipboardAsSvg: "Kopierade {{exportSelection}} till urklipp som SVG\n({{exportColorScheme}})",
  ...
  elementLinkCopied: "L\xE4nk har kopierats till urklipp"
};
var colors = {
...
var quickSearch = {
  placeholder: "Snabbs\xF6k"
};
var fontList = {
  badge: {
    old: "gammal"
  },
  sceneFonts: "I den h\xE4r scenen",
  availableFonts: "Tillg\xE4ngliga typsnitt",
  empty: "Inga typsnitt hittades"
};
var userList = {
  empty: "Inga anv\xE4ndare hittades",
  hint: {
    text: "Klicka p\xE5 anv\xE4ndaren f\xF6r att f\xF6lja",
    followStatus: "Du f\xF6ljer den h\xE4r anv\xE4ndaren",
    inCall: "Anv\xE4ndaren \xE4r i ett r\xF6stsamtal",
    micMuted: "Anv\xE4ndarens mikrofon \xE4r avst\xE4ngd",
    isSpeaking: "Anv\xE4ndaren pratar"
  }
};
var commandPalette = {
  ...
  recents: "Nyligen anv\xE4nda",
  search: {
    placeholder: "S\xF6k menyer, kommandon och uppt\xE4ck dolda p\xE4rlor",
    noMatch: "Inga matchande kommandon..."
  },
  itemNotAvailable: "Kommandot \xE4r inte tillg\xE4ngligt...",
  shortcutHint: "F\xF6r kommandopalett, anv\xE4nd {{shortcut}}"
};
var keys = {
  ctrl: "",
  option: "",
...
//# sourceMappingURL=sv-SE-V7LTZSNY.js.map
