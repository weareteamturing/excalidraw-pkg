...
var labels = {
  ...
  stroke: "Tratto",
  changeStroke: "Cambia il colore del tratto",
  background: "Sfondo",
  changeBackground: "Cambia il colore dello sfondo",
  fill: "Riempimento",
  ...
  arrowtype_elbowed: "Freccia a gomito",
  ...
  clearCanvas: "Pulisci area di disegno",
  layers: "Livelli",
  actions: "Azioni",
  language: "Lingua",
  ...
  loadScene: "Carica scena da file",
  align: "Allinea",
  ...
  showFonts: "Mostra selettore font",
  ...
  link: {
    edit: "Modifica link",
    editEmbed: "Modifica link incorporabile",
    create: "Aggiungi link",
    label: "Link",
    labelEmbed: "Collega & incorpora",
    empty: "Nessun collegamento impostato",
    hint: "Digita o incolla qui il tuo link",
    goToElement: "Vai all'elemento di destinazione"
  },
  lineEditor: {
    edit: "Modifica linea",
  ...
  polygon: {
    breakPolygon: "Interrompi poligono",
  ...
  prompt: "Prompt",
  followUs: "Seguici",
  discordChat: "Chat di Discord",
  zoomToFitViewport: "Ingrandisci per adattarsi alla vista",
  zoomToFitSelection: "Ingrandisci per adattare la selezione",
  zoomToFit: "Zoom per adattare tutti gli elementi",
  installPWA: "Installa Excalidraw localmente (PWA)",
  autoResize: "Abilita ridimensionamento automatico del testo",
  imageCropping: "Ritaglio immagine",
  unCroppedDimension: "Dimensione non ritagliata",
  copyElementLink: "Copia il link all'oggetto",
...
var elementLink = {
  ...
  desc: "Fare clic su una forma su tela o incollare un link.",
  notFound: "L'oggetto collegato non \xE8 stato trovato sulla tela."
};
var library = {
...
var search = {
  ...
  noMatch: "Non \xE8 stato trovato nessun risultato...",
...
var buttons = {
  ...
  systemMode: "Modalit\xE0 del sistema",
...
var errors = {
  ...
  saveLibraryError: "Impossibile salvare la libreria nell'archiviazione. Si prega di salvare la libreria in un file locale per assicurarsi di non perdere le modifiche.",
...
var toolBar = {
  ...
  link: "Aggiungi / aggiorna collegamento per una forma selezionata",
  eraser: "Gomma",
  frame: "Strumento riquadro",
  magicframe: "Dal wireframe al codice",
...
var hints = {
  ...
  arrowTool: "Fai clic per iniziare pi\xF9 punti, trascina per una singola linea. Premi di nuovo {{shortcut}} per cambiare il tipo di freccia.",
  ...
  lineEditor_nothingSelected: "Seleziona un punto da modificare (tieni premuto {{shortcut_1}} per selezionarne pi\xF9 di uno),\noppure tieni premuto {{shortcut_2}} e fai clic per aggiungere nuovi punti",
  ...
  deepBoxSelect: "Tieni premuto {{shortcut}} per selezionare in profondit\xE0 e per evitare il trascinamento",
...
var roomDialog = {
  desc_intro: "Invita altri a collaborare al tuo disegno.",
  desc_privacy: "Non preoccuparti, la sessione utilizza la crittografia end-to-end ed \xE8 completamente privata. Nemmeno il nostro server \xE8 in grado di vedere ci\xF2 che disegni.",
...
var helpDialog = {
  ...
  createFlowchart: "Crea un diagramma di flusso da un elemento generico",
  navigateFlowchart: "Naviga un diagramma di flusso",
  ...
  cropStart: "Ritaglia immagine",
  cropFinish: "Termina ritaglio immagine"
};
...
var stats = {
  ...
  storage: "Memoria",
  fullTitle: "Propriet\xE0 della tela & forma",
  title: "Propriet\xE0",
  generalStats: "Generale",
  elementProperties: "Propriet\xE0 delle forme",
  total: "Totale",
  version: "Versione",
...
var toast = {
  ...
  copyToClipboardAsSvg: "Copiato {{exportSelection}} negli appunti come SVG\n({{exportColorScheme}})",
  ...
  elementLinkCopied: "Link copiato negli appunti"
};
var colors = {
...
var chat = {
  ...
  retry: "Riprova",
  errors: {
    promptTooShort: "Il prompt \xE8 troppo corto (min {{min}} caratteri)",
    promptTooLong: "Il prompt \xE8 troppo lungo (max {{max}} caratteri)",
    generationFailed: "Generazione non riuscita",
    invalidDiagram: "\xC8 stato generato un diagramma non valido :(. Puoi modificarlo manualmente, riprovare con la correzione automatica o provare un prompt diverso.",
  ...
  rateLimit: {
    messageLimit: "Hai raggiunto il tuo limite di IA sul piano gratuito. Prova Excalidraw+ per saperne di pi\xF9 o torna domani.",
...
var fontList = {
  ...
  sceneFonts: "In questa scena",
  availableFonts: "Font disponibili",
  empty: "Nessun font trovato"
};
var userList = {
  ...
  hint: {
    ...
    inCall: "Utente \xE8 in una chiamata vocale",
    micMuted: "Il microfono dell'utente \xE8 disattivato",
    isSpeaking: "L'utente sta parlando"
  }
};
var commandPalette = {
  title: "Comando della tavolozza",
  shortcuts: {
    select: "Selezione",
    confirm: "Conferma",
    close: "Chiudi"
  },
  recents: "Usate di recente",
  search: {
    placeholder: "Cerca menu, comandi e scopri gemme nascoste",
    noMatch: "Nessun comando corrisponde..."
  },
  itemNotAvailable: "Il comando non \xE8 disponibile...",
...
//# sourceMappingURL=it-IT-5XPZR7KW.js.map
