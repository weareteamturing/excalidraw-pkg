...
var labels = {
  paste: "Einf\xFCgen",
  pasteAsPlaintext: "Als unformatierten Text einf\xFCgen",
  ...
  stroke: "Strich",
  changeStroke: "Strichfarbe \xE4ndern",
  background: "Hintergrund",
  changeBackground: "Hintergrundfarbe \xE4ndern",
  fill: "F\xFCllung",
  ...
  arrowhead_crowfoot_many: "Kr\xE4henfu\xDF (viele)",
  arrowhead_crowfoot_one: "Kr\xE4henfu\xDF (einer)",
  arrowhead_crowfoot_one_or_many: "Kr\xE4henfu\xDF (einer oder viele)",
  ...
  clearCanvas: "Zeichenfl\xE4che l\xF6schen",
  layers: "Ebenen",
  actions: "Aktionen",
  language: "Sprache",
  ...
  decreaseFontSize: "Schriftgr\xF6\xDFe verringern",
  increaseFontSize: "Schriftgr\xF6\xDFe erh\xF6hen",
  ...
  link: {
    ...
    create: "Link hinzuf\xFCgen",
    label: "Link",
    labelEmbed: "Verlinken & einbetten",
    empty: "Kein Link festgelegt",
    hint: "Link hier eingeben oder einf\xFCgen",
  ...
  autoResize: "Aktiviere automatische Textgr\xF6\xDFenanpassung",
...
var elementLink = {
  ...
  desc: "Klicke auf eine Form auf der Zeichenfl\xE4che oder f\xFCge einen Link ein.",
  notFound: "Verkn\xFCpftes Objekt wurde nicht auf der Zeichenfl\xE4che gefunden."
};
var library = {
...
var search = {
  title: "Auf Zeichenfl\xE4che suchen",
  noMatch: "Keine Treffer gefunden...",
  singleResult: "Ergebnis",
  multipleResults: "Ergebnisse",
  placeholder: "Text auf Zeichenfl\xE4che suchen...",
  frames: "",
  texts: "Texte"
};
var buttons = {
...
var errors = {
  ...
  saveLibraryError: "Bibliothek konnte nicht gespeichert werden. Bitte speichere deine Bibliothek lokal in einer Datei, um sicherzustellen, dass keine \xC4nderungen verloren gehen.",
...
var roomDialog = {
  ...
  desc_privacy: "Keine Sorge, die Sitzung ist Ende-zu-Ende verschl\xFCsselt und vollst\xE4ndig privat. Nicht einmal unser Server kann sehen, was du zeichnest.",
...
var stats = {
  ...
  storage: "Speicher",
  fullTitle: "Zeichenfl\xE4chen- & Formeigenschaften",
  title: "Eigenschaften",
...
var fontList = {
  ...
  availableFonts: "Verf\xFCgbare Schriftarten",
...
var commandPalette = {
  ...
  search: {
    placeholder: "Suche in Men\xFCs und Befehlen, entdecke versteckte Funktionen",
    noMatch: "Keine passenden Befehle..."
  },
  itemNotAvailable: "Befehl ist nicht verf\xFCgbar...",
  shortcutHint: "Benutze {{shortcut}} f\xFCr Befehlspalette"
};
var keys = {
  ctrl: "Strg",
  option: "",
...
//# sourceMappingURL=de-CH-COFG23OC.js.map
