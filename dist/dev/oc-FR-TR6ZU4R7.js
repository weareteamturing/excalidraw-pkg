...
var labels = {
  ...
  copySource: "Copiar la font al quichapapi\xE8rs",
  convertToCode: "Convertir lo c\xF2di",
  ...
  stroke: "Contorn",
  changeStroke: "Modificar la color d\u2019emplenament",
  background: "R\xE8ireplan",
  changeBackground: "Modificar la color de r\xE8ireplan",
  fill: "Empliment",
  ...
  arrowhead_bar: "Barra",
  arrowhead_circle: "C\xE8rcle",
  arrowhead_circle_outline: "C\xE8rcle (contorn)",
  ...
  clearCanvas: "Escafar canab\xE0s",
  layers: "Calques",
  actions: "Accions",
  language: "Lenga",
  ...
  loadScene: "Cargar una sc\xE8na d\u2019un fichi\xE8r",
  align: "Alinhament",
  ...
  textToDiagram: "T\xE8xte pel diagram",
  prompt: "Fen\xE8stra de dial\xF2g",
  followUs: "Seguiss\xE8tz-nos",
  ...
  installPWA: "",
  autoResize: "",
  imageCropping: "Talhatge d\u2019imatge",
  unCroppedDimension: "",
  copyElementLink: "Copiar lo ligam cap a l\u2019obj\xE8cte",
  linkToElement: "Ligam cap a l\u2019obj\xE8cte",
...
var library = {
  ...
  search: {
    inputPlaceholder: "Cercar dins la bibliot\xE8ca",
    heading: "",
    noResults: "",
    clearSearch: "Escafar la rec\xE8rca"
  }
};
var search = {
  title: "",
...
var errors = {
  ...
  saveLibraryError: "",
  collabSaveFailed: "Enregistrament impossible dins la basa de donada del backend. Se lo probl\xE8ma persist\xEDs, deuriatz enregistrar lo fichi\xE8r localament per vos assegurar que perdretz pas v\xF2stre trabalh.",
  collabSaveFailed_sizeExceeded: "Enregistrament impossible dins la basa de donada del backend, lo canab\xE0s sembla tr\xF2p pesuc. Deuriatz enregistrar lo fichi\xE8r localament per vos assegurar que perdretz pas v\xF2stre trabalh.",
  imageToolNotSupported: "Los imatges son desactivats.",
  brave_measure_text_error: {
    line1: "Semblatz utilizar lo navegador Brave amb lo param\xE8tre <bold>Blocatge agressiu de las emprentas numericas</bold> activat.",
    line2: "Aqu\xF2 p\xF2t menar a copar <bold>l\u2019element T\xE8xte</bold> de v\xF2stres dessenhs.",
    line3: "Recomandam f\xF2rt de desactivar aqueste param\xE8tre. Pod\xE8tz seguir <link>aquestas etapas</link> per veire coss\xED o far.",
    line4: "Se la desactivacion d'aqueste param\xE8tre correg\xEDs pas l'afichatge dels elements de t\xE8xt, vos convidam a dobrir un <issueLink>tiquet</issueLink> sus n\xF2stre GitHub, o a nos escriure sus <discordLink>Discord</discordLink>"
  },
  libraryElementTypeError: {
    embeddable: "Los elements integrats se p\xF2don pas apondre a la bibliot\xE8ca.",
    iframe: "Los elements d\u2019IFrame se p\xF2don pas apondre a la bibliot\xE8ca.",
    image: "La foncionalitat d'apondre d'imatges a la bibliot\xE8ca arribar\xE0 l\xE8u !"
  },
...
var hints = {
  ...
  bindTextToElement: "{{shortcut}} per apondre un t\xE8xt",
  createFlowchart: "",
  deepBoxSelect: "",
  eraserRevert: "",
...
var helpDialog = {
  ...
  editText: "Modificar t\xE8xt / apondre etiqueta",
...
var stats = {
  ...
  fullTitle: "Proprietats de canab\xE0s e de f\xF2rmas",
  title: "Propietats",
  generalStats: "General",
  elementProperties: "Proprietats de f\xF2rma",
  total: "Total",
  version: "Version",
...
var toast = {
  ...
  elementLinkCopied: "Copiats al quichapapi\xE8rs"
};
var colors = {
...
var overwriteConfirm = {
  action: {
    exportToImage: {
      ...
      description: "Exportar las donadas de la sc\xE8na coma un imatge que pod\xE8tz importar mai tard."
    },
    saveToDisk: {
  ...
  modal: {
    loadFromFile: {
      ...
      description: "Lo cargament dempu\xE8i un fichi\xE8r <bold>rempla\xE7ar\xE0 v\xF2stre contengut actual</bold>.<br></br>Pod\xE8tz d'en primi\xE8r far una c\xF2pia de seguretat de v\xF2stre dessenh en utilizant una de las opcions \xE7aij\xF3s."
    },
    shareableLink: {
      title: "Cargar d\u2019un ligam",
      button: "Rempla\xE7ar mon contengut",
      description: "Lo cargament d'un dessenh ext\xE8rne <bold>rempla\xE7ar\xE0 v\xF2stre contengut existent</bold>.<br></br>Pod\xE8tz d'en primi\xE8r far una c\xF2pia de seguretat de v\xF2stre dessenh en utilizant una de las opcions \xE7aij\xF3s."
    }
  }
};
var mermaid = {
  ...
  button: "Inserir",
  description: "Actualament, sonque los diagramas <flowchartLink>logics</flowchartLink>,<sequenceLink> de sequ\xE9ncia</sequenceLink> e <classLink>de classa </classLink>son preses en carga. Los autres tipes ser\xE0n afichats coma imatge dins Excalidraw.",
...
var quickSearch = {
  placeholder: "Rec\xE8rca rapida"
};
var fontList = {
  badge: {
    old: "ancian"
  },
  sceneFonts: "Dins aquesta sc\xE8na",
  availableFonts: "Polissas disponiblas",
  empty: "Cap de polissa pas trobada"
};
var userList = {
  empty: "Cap d\u2019utilizaire pas trobat",
  hint: {
    text: "Clicar l\u2019utilizaire per lo seguir",
    followStatus: "Seguiss\xE8tz actualament aqueste utilizaire",
    inCall: "L\u2019utilizaire es en conversacion vocala",
    micMuted: "Lo microf\xF2n de l\u2019utilizaire es mut",
    isSpeaking: "La persona parla"
  }
};
var commandPalette = {
  title: "Paleta de comanda",
  shortcuts: {
    select: "Seleccionar",
    confirm: "Confirmar",
    close: "Tampar"
  },
  recents: "Utilizada recentament",
  search: {
    placeholder: "",
    noMatch: ""
  },
...
//# sourceMappingURL=oc-FR-TR6ZU4R7.js.map
