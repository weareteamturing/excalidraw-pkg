...
var labels = {
  ...
  stroke: "Obrys",
  changeStroke: "Zmeni\u0165 farbu or\xE1movania",
  background: "Pozadie",
  ...
  arrowtypes: "Typ \u0161\xEDpky",
  arrowtype_sharp: "Ostr\xE1 \u0161\xEDpka",
  arrowtype_round: "Zakriven\xE1 \u0161\xEDpka",
  arrowtype_elbowed: "Zalomen\xE1 \u0161\xEDpka",
  ...
  clearCanvas: "Vy\u010Disti\u0165 pl\xE1tno",
  layers: "Vrstvy",
  actions: "Akcie",
  language: "Jazyk",
  ...
  loadScene: "Na\u010D\xEDta\u0165 sc\xE9nu zo s\xFAboru",
  align: "Zarovnanie",
  ...
  showFonts: "Zobrazi\u0165 v\xFDber p\xEDsma",
  toggleTheme: "Prepn\xFA\u0165 svetl\xFA/tmav\xFA t\xE9mu",
  theme: "T\xE9ma",
  ...
  link: {
    edit: "Upravi\u0165 odkaz",
    editEmbed: "Editova\u0165 zapusten\xFD odkaz",
    create: "Prida\u0165 odkaz",
    label: "Odkaz",
    labelEmbed: "Zapusti\u0165 odkaz",
    empty: "Nie je nastaven\xFD \u017Eiaden odkaz",
    hint: "Zadajte alebo vlo\u017Ete v\xE1\u0161 odkaz",
    goToElement: "Prejs\u0165 k cielen\xE9mu prvku"
  },
  lineEditor: {
    edit: "Upravi\u0165 \u010Diaru",
    editArrow: "Upravi\u0165 \u0161\xEDpku"
  },
  polygon: {
    breakPolygon: "Rozdeli\u0165 polyg\xF3n",
    convertToPolygon: "Zmeni\u0165 na polyg\xF3n"
  },
  elementLock: {
    lock: "Zamkn\xFA\u0165",
    unlock: "Odomkn\xFA\u0165",
  ...
  prompt: "In\u0161trukcia",
  followUs: "Sledujte n\xE1s",
  discordChat: "Discord chat",
  zoomToFitViewport: "Pribl\xED\u017Ei\u0165 na ve\u013Ekos\u0165 zobrazenia",
  zoomToFitSelection: "Pribl\xED\u017Ei\u0165 na v\xFDber",
  zoomToFit: "Pribl\xED\u017Ei\u0165 aby boli zahrnut\xE9 v\u0161etky prvky",
  installPWA: "In\u0161talova\u0165 Excalidraw lok\xE1lne (PWA)",
  autoResize: "Zapn\xFA\u0165 automatick\xFA zmenu ve\u013Ekosti textu",
  imageCropping: "Orezanie obr\xE1zka",
  unCroppedDimension: "P\xF4vodn\xE9 rozmery",
  copyElementLink: "Kop\xEDrova\u0165 odkaz na objekt",
  linkToElement: "Odkaz na objekt",
  wrapSelectionInFrame: "Zabali\u0165 v\xFDber do r\xE1mu",
  tab: "Tab",
  shapeSwitch: "Zmeni\u0165 tvar"
};
var elementLink = {
  title: "Odkaz na objekt",
  desc: "Kliknite na tvar na pl\xE1tne alebo vlo\u017Ete odkaz.",
  notFound: "Odk\xE1zan\xFD objekt nebol n\xE1jden\xFD na pl\xE1tne."
};
var library = {
  ...
  search: {
    inputPlaceholder: "Preh\u013Ead\xE1va\u0165 kni\u017Enicu",
    heading: "V\xFDsledky z kni\u017Enice",
    noResults: "Neboli n\xE1jden\xE9 \u017Eiadne v\xFDsledky...",
    clearSearch: "Vymaza\u0165 vyh\u013Ead\xE1vanie"
  }
};
var search = {
  title: "Vyh\u013Eada\u0165 v pl\xE1tne",
  noMatch: "Neboli n\xE1jden\xE9 \u017Eiadne v\xFDsledky...",
  singleResult: "v\xFDsledok",
  multipleResults: "v\xFDsledky",
  placeholder: "Vyh\u013Eada\u0165 text v pl\xE1tne...",
  frames: "R\xE1mce",
  texts: "Texty"
};
var buttons = {
  ...
  systemMode: "Syst\xE9mov\xFD re\u017Eim",
  zenMode: "Re\u017Eim zen",
  objectsSnapMode: "Prichyti\u0165 k objektom",
  exitZenMode: "Zru\u0161i\u0165 re\u017Eim zen",
  cancel: "Zru\u0161i\u0165",
  saveLibNames: "Ulo\u017Ei\u0165 n\xE1zvy a ukon\u010Di\u0165",
  clear: "Vymaza\u0165",
  remove: "Odstr\xE1ni\u0165",
...
var alerts = {
  ...
  importBackendFailed: "Nepodarilo sa importovanie zo serveru.",
  ...
  localStorageQuotaExceeded: "Pam\xE4\u0165 prehliada\u010Da je pln\xE1. Zmeny nebud\xFA ulo\u017Een\xE9."
};
var errors = {
  ...
  saveLibraryError: "Nepodarilo sa ulo\u017Ei\u0165 kni\u017Enicu. Pros\xEDm ulo\u017Ete si va\u0161u kni\u017Enicu lok\xE1lne do s\xFAboru, aby ste nestratili zmeny.",
...
var toolBar = {
  ...
  convertElementType: "Prepn\xFA\u0165 typ tvaru"
};
var element = {
  rectangle: "Obd\u013A\u017Enik",
  diamond: "Diamant",
...
var hints = {
  dismissSearch: "{{shortcut}} pre zru\u0161enie vyh\u013Ead\xE1vania",
  canvasPanning: "Pre pohyb pl\xE1tna podr\u017Ete {{shortcut_1}} alebo {{shortcut_2}} po\u010Das \u0165ahania, alebo pou\u017Eite n\xE1stroj ruka",
  linearElement: "Kliknite na vlo\u017Eenie viacer\xFDch bodov, potiahnite na vytvorenie jednej priamky",
  arrowTool: "Kliknite pre za\u010Datie prid\xE1vania viacer\xFDch bodov, potiahnite pre pridanie jednej \u010Diary. Stla\u010Dte znovu {{shortcut}} pre zmenu typu \u0161\xEDpky.",
  arrowBindModifiers: "Podr\u017Ete {{shortcut_1}} na zru\u0161enie prichyt\xE1vania alebo {{shortcut_2}} na prichyt\xE1vanie k pevn\xE9mu bodu",
  ...
  linearElementMulti: "Kliknite na posledn\xFD bod alebo sta\u010Dte {{shortcut_1}} alebo {{shortcut_2}} pre ukon\u010Denie",
  lockAngle: "Po\u010Das rot\xE1cie obmedz\xEDte uhol podr\u017Ean\xEDm {{shortcut}}",
  resize: "Po\u010Das zmeny ve\u013Ekosti zachov\xE1te proporcie podr\u017Ean\xEDm {{shortcut_1}}, podr\u017Ean\xEDm {{shortcut_2}} men\xEDte ve\u013Ekos\u0165 so zachovan\xEDm stredu",
  resizeImage: "Podr\u017Ete {{shortcut_1}} pre vo\u013En\xFA zmenu ve\u013Ekosti, podr\u017Ete {{shortcut_2}} pre zmenu ve\u013Ekosti od stredu",
  rotate: "Po\u010Das rot\xE1cie obmedz\xEDte uhol podr\u017Ean\xEDm {{shortcut}}",
  ...
  lineEditor_nothingSelected: "Zvo\u013Ete bod na upravovanie (podr\u017Ete {{shortcut_1}} pre zvolenie viacer\xFDch bodov) alebo podr\u017Ete {{shortcut_2}} a kliknite na pridanie nov\xE9ho bodu",
  publishLibrary: "Uverejni\u0165 va\u0161u kni\u017Enicu",
  bindTextToElement: "{{shortcut}} na pridanie textu",
  createFlowchart: "{{shortcut}} pre vytvorenie v\xFDvojov\xE9ho diagramu",
  deepBoxSelect: "Podr\u017Ete {{shortcut}} na v\xFDber v skupine alebo zamedzeniu potiahnutia",
  eraserRevert: "Podr\u017Ete {{shortcut}} pre prehodenie polo\u017Eiek ur\u010Den\xFDch na vymazanie",
  ...
  disableSnapping: "Podr\u017Ete {{shortcut}} pre vypnutie prichyt\xE1vania",
  enterCropEditor: "Kliknite dva kr\xE1t na obr\xE1zok alebo stla\u010Dte {{shortcut}} pre jeho orezanie",
  leaveCropEditor: "Kliknite mimo obr\xE1zka, alebo sta\u010Dte {{shortcut_1}} alebo {{shortcut_2}} pre ukon\u010Denie orez\xE1vania"
};
var canvasError = {
...
var roomDialog = {
  desc_intro: "Pozvite \u013Eud\xED a spolupracujte s nimi na va\u0161ich kresb\xE1ch.",
  desc_privacy: "Nemajte obavy, rel\xE1cia je end-to-end \u0161ifrovan\xE1 a \xFAplne priv\xE1tna. Ani n\xE1\u0161 server nedok\xE1\u017Ee vidie\u0165 \u010Do kresl\xEDte.",
...
var helpDialog = {
  ...
  deepBoxSelect: "V\xFDber v skupine alebo zamedzenie potiahnutia",
  createFlowchart: "Vytvorte v\xFDvojov\xFD diagram z generick\xE9ho prvku",
  navigateFlowchart: "Navig\xE1cia v diagrame",
  ...
  howto: "Postupujte pod\u013Ea na\u0161ich n\xE1vodov",
  or: "alebo",
  ...
  cropStart: "Oreza\u0165 obr\xE1zok",
  cropFinish: "Dokon\u010Di\u0165 orez\xE1vanie obr\xE1zka"
};
...
var stats = {
  ...
  selected: "Vybran\xE9",
  storage: "\xDAlo\u017Eisko",
  fullTitle: "Vlastnosti pl\xE1tna a tvaru",
  title: "Vlastnosti",
  generalStats: "V\u0161eobecn\xE9",
...
var toast = {
  ...
  copyToClipboardAsSvg: "Kop\xEDrovanie {{exportSelection}} do schr\xE1nky ako SVG prebehlo \xFAspe\u0161ne\n({{exportColorScheme}})",
  ...
  elementLinkCopied: "Odkaz bol skop\xEDrovan\xFD do schr\xE1nky"
};
var colors = {
...
var quickSearch = {
  placeholder: "R\xFDchle vyh\u013Ead\xE1vanie"
};
var fontList = {
  badge: {
    old: "star\xE9"
  },
  sceneFonts: "V tejto sc\xE9ne",
  availableFonts: "Dostupn\xE9 p\xEDsma",
  empty: "Nena\u0161li sa \u017Eiadne p\xEDsma"
};
var userList = {
  empty: "Nena\u0161li sa \u017Eiadni pou\u017E\xEDvatelia",
  hint: {
    text: "Kliknite na pou\u017E\xEDvate\u013Ea pre jeho sledovanie",
    followStatus: "Aktu\xE1lne sledujete tohto pou\u017E\xEDvate\u013Ea",
    inCall: "Pou\u017E\xEDvate\u013E je \xFA\u010Dastn\xEDk hovoru",
    micMuted: "Pou\u017E\xEDvate\u013E m\xE1 stlmen\xFD mikrof\xF3n",
    isSpeaking: "Pou\u017E\xEDvate\u013E hovor\xED"
  }
};
var commandPalette = {
  title: "Paleta pr\xEDkazov",
  shortcuts: {
    select: "Vybra\u0165",
    confirm: "Potvrdi\u0165",
    close: "Zavrie\u0165"
  },
  recents: "Ned\xE1vno pou\u017Eit\xE9",
  search: {
    placeholder: "Preh\u013Ead\xE1vajte menu, pr\xEDkazy a objavte skryt\xE9 poklady",
    noMatch: "\u017Diadne vyhovuj\xFAce pr\xEDkazy..."
  },
  itemNotAvailable: "Pr\xEDkaz nie je dostupn\xFD...",
  shortcutHint: "Pou\u017Eite paletu pr\xEDkazov pomocou {{shortcut}}"
};
var keys = {
  ctrl: "Ctrl",
  option: "Option",
...
//# sourceMappingURL=sk-SK-KEPA6RNL.js.map
